...
function Main() {
    return {
        ...
        async init() {
            ...
            this.meshes['teapot'] = this.parseObj(teapotText)
            ...
            let drawObj = regl({
                ...
                attributes: {
                    position: this.meshes[this.object.mesh].pos,
                    normal: this.meshes[this.object.mesh].normal
                },
                ...
                // Number of triangles
                elements: this.meshes[this.object.mesh].faces
            })
